...
#include <pcl/visualization/point_cloud_color_handler.h>
...
public:
	...
	SimpleHDLViewer (Grabber& grabber, pcl::visualization::PointCloudColorHandler<pcl::PointXYZI> & handler):cloud_viewer_(new pcl::visualization::PCLVisualizer ("PCL HDL Cloud")),grabber_(grabber),handler_(handler)
	{
	}	
	...
	void run()
	{
		...
		cloud_viewer_->setCameraPosition (0.0,0.0,30.0,0.0,1.0,0);
	...
	pcl::visualization::PointCloudColorHandler<pcl::PoitnXYZ> &handler_;
...
int main(int argc, char** argv)
{
	...
	pcl::HDLGrabber grabber (hdlCalibration,pacpFile);
